...
class InstaPayPayment extends StatefulWidget {
  const InstaPayPayment({super.key});
  static String id = 'InstaPayPayment';
  @override
  State<InstaPayPayment> createState() => _InstaPayPaymentState();
}

class _InstaPayPaymentState extends State<InstaPayPayment> {
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                const TextSpan(
                                  text:
                                      'برجاء تحويل المبلغ إلى رقم انستا باي التالي ',
                                  style: TextStyle(
                                    fontWeight: FontWeight.w600,
